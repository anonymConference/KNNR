...
Nsample_list = [100,10000]#[2500,5000,7500,10000, 25000]#[100]#
eps = 1.0
n_reps = 30
...
for Nsample in Nsample_list:
    ...
    for i_rep in range(n_reps):
        ...
        nbrs = NearestNeighbors(n_neighbors=n_neighbors,  algorithm='ball_tree',n_jobs=72).fit(match_df )
        ...
        for i in range(num_resample):
            reward_resampled = partial_work_func(i)
