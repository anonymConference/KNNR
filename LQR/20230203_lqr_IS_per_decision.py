...
Nsample_list = [100]#[2500,5000,7500,10000]#[25000]#[100,250,500,750,1000]#[100]#[10000]#[100,250,500,750,1000]#, ,50000,100000] # Number of sample trajectories
...
for Nsample in Nsample_list:
    ...
    for i_rep in range(n_reps):
        ...
        reward_dummy=0
        for t in range(T):
                reward_dummy = reward_dummy + np.dot(reward_df[t_np==t],IS_np[t_np==t])/np.sum(IS_np[t_np==t])
