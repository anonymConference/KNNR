...
N_traj = 1000000
Nsample_list = [25000]#[100,250,500,750,1000]#[100]#[25000]#[2500,5000,7500,10000]#[10000]#[100,250,500,750,1000]#[50000]#,,100,250,500,750,1000,#[100,250,500,750,1000]#
resample_ratio = 5
n_reps = 30
...
if __name__ == '__main__':
    ...
    for Nsample in Nsample_list:
        ...
        for i_rep in range(n_reps):
            ...
            target_loss_np = np.array(loss_list)
            target_loss = np.mean(target_loss_np)   
            reward_stored[i_rep, N_ind] = np.mean(np.array(target_loss))
        N_ind=N_ind+1