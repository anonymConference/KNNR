...
N_traj = 1000000
Nsample_list = [2500,5000,7500,10000, 25000]#[100,250,500,750,1000]#[25000]##[100]#[25000]#[10000]#[100,250,500,750,1000]#[50000]#,,100,250,500,750,1000,#[100,250,500,750,1000]#
resample_ratio = 5
n_reps = 30
...
if __name__ == '__main__':
    ...
    for Nsample in Nsample_list:
        ...
        for i_rep in range(n_reps):
            ...
            for n in range(Nsample):
                ...
                for t in range(T-t_out):
                    ...
                    if q_min>0:
                        ...
                        IS_weight_prod = norm.pdf(delta_min ,loc=delta_opt, scale=0.0001)/behaviour_density 
                        #print(IS_weight)
                        action_list.append(delta_min) 
            ...
            reward_stored[i_rep, N_ind] = np.dot(rewards,IS)/sum(IS)#
        N_ind=N_ind+1