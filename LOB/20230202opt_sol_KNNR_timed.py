...
N_traj = 50000
Nsample_list = [2500,5000,7500,10000]#[100,250,500,750,1000]#[100000]#[50000]#,,100,250,500,750,1000,#[100,250,500,750,1000]#
resample_ratio = 5
n_reps = 30
    ...
    for Nsample in Nsample_list:
        ...
        for i_rep in range(n_reps):
            ...
            for i in range(num_resample):
                resampled_reward = worker_func(i+i*i_rep+1010, initial_states, T, nbrs,S0, K_opt,size_feature)
                resampled_reward_list.append(resampled_reward)
                
        
                    
                
            resampled_loss = np.array(resampled_reward_list)
            
            
         
            reward_stored[i_rep, N_ind] = np.mean(resampled_loss)
